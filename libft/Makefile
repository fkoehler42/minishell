...
SRC = ft_atoi.c ft_atol.c ft_bzero.c ft_isalnum.c ft_countwords.c ft_isalpha.c \
ft_isascii.c ft_isspace.c ft_isdigit.c ft_isprint.c ft_itoa.c ft_ltoa_base.c \
